...
function _customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'title'       => esc_html__( 'Social Links', 'omarsamad' ),
			'description' => esc_html__( 'These are the settings for social links. Please limit the number of social links to 5.', 'omarsamad' ),
			'priority'    => 90,
		)
	);
	...
	foreach ( $social_networks as $network ) {
	    ...
	    $wp_customize->add_control(
	        '_' . $network . '_link',
	        array(
	            'label'   => sprintf( esc_html__( '%s Link', 'omarsamad' ), ucwords( $network ) ),
	...
	$wp_customize->add_section(
		'_footer_section',
		array(
			'title'    => esc_html__( 'Footer Customization', 'omarsamad' ),
			'priority' => 90,
		)
	);
	...
	$wp_customize->add_control(
		'_copyright_text',
		array(
			'label'       => esc_html__( 'Copyright Text', 'omarsamad' ),
			'description' => esc_html__( 'The copyright text will be displayed beneath the menu in the footer.', 'omarsamad' ),
...
function _customize_preview_js() {
	wp_enqueue_script( '_customizer', get_template_directory_uri() . '/assets/scripts/customizer.js', array( 'customize-preview' ), '20151215', true );
}
